...
// ResourceV1beta2Client is used to interact with features provided by the resource.nvidia.com group.
type ResourceV1beta2Client struct {
	restClient rest.Interface
}

func (c *ResourceV1beta2Client) ComputeDomains(namespace string) ComputeDomainInterface {
