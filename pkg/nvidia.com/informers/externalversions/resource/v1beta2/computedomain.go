...
import (
	...
	resourcev1beta2 "sigs.k8s.io/dra-driver-nvidia-gpu/api/nvidia.com/resource/v1beta2"
	...
	v1beta2 "sigs.k8s.io/dra-driver-nvidia-gpu/pkg/nvidia.com/listers/resource/v1beta2"
)
...
type ComputeDomainInformer interface {
	...
	Lister() v1beta2.ComputeDomainLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ResourceV1beta2().ComputeDomains(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ResourceV1beta2().ComputeDomains(namespace).Watch(context.TODO(), options)
			},
		},
		&resourcev1beta2.ComputeDomain{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *computeDomainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resourcev1beta2.ComputeDomain{}, f.defaultInformer)
}

func (f *computeDomainInformer) Lister() v1beta2.ComputeDomainLister {
	return v1beta2.NewComputeDomainLister(f.Informer().GetIndexer())
}
